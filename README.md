# 👋 Hello, I’m Florin Marius Drilea
...
**Backend:**  
Spring Boot, JPA, REST APIs, Graphql, Kubernetes, Microservices, CI/CD, Kafka, Redis, MySQL, AWS, Couchbase, Liquibase, Wiremock, TestContainers

**Tools:**  
Jenkins, Git, Docker, Prometheus, Grafana, Sonarqube, Jira, Terraform, Linux
...
- ⚙️ Migrated CI/CD Jnekins at Sky Betting & Gaming
- 🚀 Delivered customer-facing features with measurable impact (+20% engagement) at Sky Betting & Gaming
- 📈 Improved language side microservice performance by 30% at THG

---

### 🤝 Let’s Connect

I love building scalable systems, clean architecture, and learning new tech.  
Always open to opportunities, collaboration, and cool ideas.
